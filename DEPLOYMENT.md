...
- `SMTP_PASS`
- `SMTP_FROM`
- `TELEGRAM_PAYMENT_BOT_TOKEN` — unified `@easymed_notifications_bot` token
- `TELEGRAM_NOTIFICATIONS_CHAT_ID` — common chat ID (`284467225`)
- `TELEGRAM_PAYMENTS_SUCCESS_THREAD_ID`
- `TELEGRAM_PAYMENTS_ERRORS_THREAD_ID`
- `TELEGRAM_GENERAL_ERRORS_THREAD_ID`
